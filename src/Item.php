...
abstract class Item extends Entity
{
    ...
    /**
     * @var array $default The default properties
     */
    protected static array $default = [];

    /**
     * @var array $default_override The list of overrides, when generating the default properties
     */
    protected static array $default_override = [];

    /**
     * @var array $default_ignore The properties not to include on the list of default properties
     */
     ...
     */
    protected static array $frozen_fields = ['errors', 'fields', 'original'];
}
