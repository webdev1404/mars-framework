...
use Mars\Asset\Javascript as JsAsset;
...
class Javascript extends Links
{
    ...
    public function renderCodes(string $location)
    {
        ...
        parent::renderCodes($location);
    }

    /**
     * Renders the given javascript $code
    ...
    /**
     * Renders the javascript config as a global variable, if any
     */
    protected function renderConfig()
    {
        ...
        $this->renderCode('window.MarsConfigData = ' . $this->encode($this->config) . ';');
    }
