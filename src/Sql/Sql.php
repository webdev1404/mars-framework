 ...
 * The Sql Builder Base Class.
 */
abstract class Sql implements DriverInterface
{
    /**
    ...
    /**
     * @see DriverInterface::valuesMulti()
     * {@inheritdoc}
     */
    ...
    /**
     * @see DriverInterface::selectCount()
     * {@inheritdoc}
     */
