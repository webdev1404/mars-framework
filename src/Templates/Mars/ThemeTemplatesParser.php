...
/**
 * The Theme Templates Parser
 * Parses {% theme-template <template_name> %} and includes the template from the theme's templates dir
 */
class ThemeTemplatesParser
{
    use InstanceTrait;
    ...
    {
        return preg_replace_callback('/\{%\s*theme(?:\-template)? +(.*)%\}/U', function (array $match) {
