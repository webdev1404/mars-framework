...
class Sql implements \Stringable
{
    ...
    public protected(set) Drivers $drivers {
        get {
            ...
            $this->drivers = new Drivers($this->supported_drivers, SqlInterface::class, 'db', $this->app);
    ...
    /**
     * @var SqlInterface $driver The driver object
     */
    public protected(set) SqlInterface $driver {
        get {
