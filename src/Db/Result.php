...
{
    /**
     * @var DbInterface $handle The handle which generated the result
     */
    protected DbInterface $handle;
     ...
     * @param DbInterface $handle The handle which generated the result
     * @param object $result The result returned by a database query
     */
    public function __construct(DbInterface $handle, object $result)
    {
        $this->handle = $handle;
        $this->result = $result;
    }
     ...
     * @return array
     */
    public function getList(string $key_col, string $col)
    {
        return $this->get($key_col, $col);
    }

    /**
     * Returns the results generated by a query as an array of arrays
     * @param string $key_field The name of the column which will be used as the returned array's key, if any
     * @param string $field If specified, will return only this field rather than all of them
     * @return array The rows
     */
