...
use Mars\Themes\Templates\Mars\VariablesParser;

include_once(dirname(__DIR__, 3) . '/Base.php');
...
final class VariablesParserTest extends Base
{
    public function testParse()
    {
        ...
        $this->assertSame($parser->parse('{{ my_str123 }}'), '<?= $this->app->escape->html($lang->get(\'my_str123\')) ?>');
